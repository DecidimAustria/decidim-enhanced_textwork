        ...
        context "when the collaborative draft is open" do
          ...
          it "notifies the requester and authors of the collaborative draft that access to requester has been rejected" do
            expect(Decidim::EventsManager)
              .to receive(:publish)
              .with(
                event: "decidim.events.enhanced_textwork.collaborative_draft_access_rejected",
                event_class: Decidim::EnhancedTextwork::CollaborativeDraftAccessRejectedEvent,
            ...
            expect(Decidim::EventsManager)
              .to receive(:publish)
              .with(
                event: "decidim.events.enhanced_textwork.collaborative_draft_access_requester_rejected",
                event_class: Decidim::EnhancedTextwork::CollaborativeDraftAccessRequesterRejectedEvent,
                resource: collaborative_draft,
