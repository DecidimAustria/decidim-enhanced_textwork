...
module Decidim
  module EnhancedTextwork
    describe ParagraphWizardCreateStepForm do
      subject { form }
      ...
      context "when the body exceeds the permited length" do
        let(:component) { create(:paragraph_component, :with_paragraph_length, participatory_space: participatory_space, paragraph_length: allowed_length) }
