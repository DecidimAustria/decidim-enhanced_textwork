...
describe Decidim::EnhancedTextwork::CollaborativeDraftCell, type: :cell do
  controller Decidim::EnhancedTextwork::CollaborativeDraftsController

  subject { my_cell.call(:show) }

  let(:my_cell) { cell("decidim/enhanced_textwork/collaborative_draft", collaborative_draft, context: context) }
