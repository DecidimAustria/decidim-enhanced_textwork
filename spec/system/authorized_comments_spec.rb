...
describe "Authorized comments", type: :system do
  let!(:commentable) { create(:paragraph, component: component, users: [author]) }
  ...
  context "when the paragraph has no restriction on commenting and voting comments" do
    before do
      visit resource_path
    end
  ...
  context "when the paragraph has restrictions on commenting and/or voting comments" do
