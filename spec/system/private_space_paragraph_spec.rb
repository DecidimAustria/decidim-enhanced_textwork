...
describe "Private Space Paragraph", type: :system do
  ...
  context "when space is private and transparent" do
    ...
    context "when the user is not logged in" do
      it "does not allow create a paragraph" do
        visit_component
    ...
    context "when the user is logged in" do
      context "and is private user space" do
        ...
        it "not allows create a paragraph" do
          visit_component

          expect(page).to have_link("New paragraph")
        end
      end
  ...
  context "when the spaces is private and not transparent" do
    ...
    context "when the user is logged in" do
      context "and is private user space" do
        ...
        it "allows create a paragraph" do
          visit_component

          click_link "New paragraph"

          within ".new_paragraph" do
            fill_in :paragraph_title, with: "Creating my paragraph"
            fill_in :paragraph_body, with: "This is my paragraph's body and I'm using it unwisely."
