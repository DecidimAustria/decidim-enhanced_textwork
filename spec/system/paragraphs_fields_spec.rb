...
describe "Paragraphs", type: :system do
  ...
  context "when creating a new paragraph" do
    let(:scope_picker) { select_data_picker(:paragraph_scope_id) }
    ...
    context "when the user is logged in" do
      ...
      context "with creation enabled" do
        ...
        let(:paragraph_draft) { create(:paragraph, :draft, component: component) }

        context "when process is not related to any scope" do
          it "can be related to a scope" do
            visit complete_paragraph_path(component, paragraph_draft)
        ...
        context "when geocoding is enabled", :serves_map, :serves_geocoding_autocomplete do
          ...
          let(:paragraph_draft) { create(:paragraph, :draft, users: [user], component: component, title: "More sidewalks and less roads", body: "He will not solve everything") }
          ...
          it "creates a new paragraph", :slow do
            ...
            within ".edit_paragraph" do
              ...
              fill_in :paragraph_title, with: "More sidewalks and less roads"
              fill_in :paragraph_body, with: "Cities need more people, not more cars"
              fill_in_geocoding :paragraph_address, with: address
          ...
          it_behaves_like(
            ...
            within_selector: ".edit_paragraph",
            address_field: :paragraph_address
          ) do
            let(:geocoded_record) { paragraph_draft }
        ...
        context "when component has extra hashtags defined" do
          ...
          it "offers and save extra hashtags", :slow do
            ...
            within ".edit_paragraph" do
              check :paragraph_suggested_hashtags_suggestedhashtag1
        ...
        context "when the user has verified organizations" do
          ...
          let(:user_group_paragraph_draft) { create(:paragraph, :draft, users: [user], component: component, title: "More sidewalks and less roads", body: "Cities need more people, not more cars") }

          before do
            create(:user_group_membership, user: user, user_group: user_group)
          end

          it "creates a new paragraph as a user group", :slow do
            visit complete_paragraph_path(component, user_group_paragraph_draft)
            ...
            within ".edit_paragraph" do
              ...
              select translated(category.name), from: :paragraph_category_id
              scope_pick scope_picker, scope
              select user_group.name, from: :paragraph_user_group_id
        ...
        context "when attachments are allowed" do
          ...
          let(:paragraph_draft) { create(:paragraph, :draft, users: [user], component: component, title: "Paragraph with attachments", body: "This is my paragraph and I want to upload attachments.") }

          it "creates a new paragraph with attachments" do
            visit complete_paragraph_path(component, paragraph_draft)

            within ".edit_paragraph" do
              fill_in :paragraph_title, with: "Paragraph with attachments"
              fill_in :paragraph_body, with: "This is my paragraph and I want to upload attachments."
              attach_file :paragraph_add_photos, Decidim::Dev.asset("city.jpeg")
              find("*[type=submit]").click
            end
      ...
      context "when creation is not enabled" do
        it "does not show the creation button" do
          visit_component
          expect(page).to have_no_link("New paragraph")
        end
      end

      context "when the paragraph limit is 1" do
        let!(:component) do
          create(:paragraph_component,
                 :with_creation_enabled,
                 :with_paragraph_limit,
                 manifest: manifest,
                 participatory_space: participatory_process)
        end

        let!(:paragraph_first) { create(:paragraph, users: [user], component: component, title: "Creating my first and only paragraph", body: "This is my only paragraph's body and I'm using it unwisely.") }
        ...
        it "allows the creation of a single new paragraph" do
          within ".new_paragraph" do
            fill_in :paragraph_title, with: "Creating my second paragraph"
            fill_in :paragraph_body, with: "This is my second paragraph's body and I'm using it unwisely."
...
def complete_paragraph_path(component, paragraph)
  "#{Decidim::EngineRouter.main_proxy(component).paragraph_path(paragraph)}/complete"
end
