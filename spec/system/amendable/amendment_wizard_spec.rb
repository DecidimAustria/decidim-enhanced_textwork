...
describe "Amendment Wizard", type: :system do
  ...
  let!(:paragraph) { create(:paragraph, title: { en: "More roads and less sidewalks" }, component: component) }
  ...
  context "when amending a paragraph" do
    before do
    ...
    context "and in step_1: Create your amendment" do
      ...
      context "when the back button is clicked" do
        ...
        it "redirects to the paragraph page" do
          expect(page).to have_content(translated(paragraph.title))
          expect(page).to have_content("AMEND PARAGRAPH")
        end
      end
    end
    ...
    context "and in step_2: Compare your amendment" do
      context "with similar results" do
        let!(:emendation) { create(:paragraph, title: { en: title }, body: { en: body }, component: component) }
    ...
    context "and in step_4: Publish your amendment" do
      ...
      context "when the Publish button is clicked", versioning: true do
        ...
        it "publishes the amendment" do
          expect(page).to have_css(".callout.warning", text: "This amendment for the paragraph #{translated(paragraph.title)} is being evaluated.")
  ...
  context "with existing amendment drafts" do
    ...
    let!(:amendment) { create :amendment, amendable: paragraph, emendation: emendation }
    let!(:emendation_draft) { create(:paragraph, :unpublished, component: component) }
    let!(:amendment_draft) { create :amendment, :draft, amendable: paragraph, emendation: emendation_draft }

    context "and visiting an amended paragraph" do
      before do
        visit paragraph_path
      end
