...
require "decidim/core/test/shared_examples/amendable_paragraphs_interface_examples"
...
module Decidim
  module EnhancedTextwork
    describe ParagraphType, type: :graphql do
      include_context "with a graphql class type"
      let(:component) { create(:paragraph_component) }
      let(:model) { create(:paragraph, :with_votes, :with_endorsements, :with_amendments, component: component) }
      ...
      include_examples "amendable paragraphs interface"
      ...
      describe "id" do
        ...
        it "returns the paragraph's id" do
      ...
      describe "voteCount" do
        ...
        context "when votes are not hidden" do
          it "returns the amount of votes for this paragraph" do
            expect(response["voteCount"]).to eq(model.votes.count)
          end
        end

        context "when votes are hidden" do
          let(:component) { create(:paragraph_component, :with_votes_hidden) }
      ...
      describe "title" do
        ...
        it "returns the paragraph's title" do
      ...
      describe "body" do
        ...
        it "returns the paragraph's body" do
      ...
      describe "state" do
        ...
        it "returns the paragraph's state" do
      ...
      context "when is answered" do
        ...
        describe "answer" do
          ...
          it "returns the paragraph's answer" do
      ...
      describe "address" do
        ...
        it "returns the address of this paragraph" do
      ...
      describe "participatory_text_level" do
        ...
        it "returns the participatory_text_level of this paragraph" do
      ...
      describe "position" do
        ...
        it "returns the position of this paragraph" do
      ...
      describe "created_in_meeting" do
        ...
        it "returns the created_in_meeting of this paragraph" do
      ...
      describe "meeting" do
        ...
        let(:model) { create(:paragraph, :official_meeting, component: component) }

        it "returns the meeting of this paragraph" do
