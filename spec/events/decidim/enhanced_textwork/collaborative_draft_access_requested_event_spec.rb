...
describe Decidim::EnhancedTextwork::CollaborativeDraftAccessRequestedEvent do
  include_context "when a simple event"

  let(:event_name) { "decidim.events.enhanced_textwork.collaborative_draft_access_requested" }
