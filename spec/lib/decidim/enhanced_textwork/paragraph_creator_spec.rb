...
describe Decidim::EnhancedTextwork::ParagraphCreator do
  ...
  let(:component) { create :component, manifest_name: :paragraphs, participatory_space: participatory_process }
  ...
  describe "#resource_klass" do
    it "returns the correct class" do
      expect(described_class.resource_klass).to be(Decidim::EnhancedTextwork::Paragraph)
    end
  end
  ...
  describe "#produce" do
    it "makes a new paragraph" do
      record = subject.produce

      expect(record).to be_a(Decidim::EnhancedTextwork::Paragraph)
